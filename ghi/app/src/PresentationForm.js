...
class PresentationForm extends React.Component {
    constructor(props) {
        ...
        this.handleSynopsisChange = this.handleTitleChange.bind(this);
    ...
    async handleSubmit(event) {
        ...
        let presentationUrl = `http://localhost:8000${data.conference}presentations/`
        let fetchConfig = {
            method: "post",
        ...
        <div className="shadow p-4 mt-4">
            ...
            <form onSubmit={this.handleSubmit} id="create-presentation-form">
                <div className="form-floating mb-3">
                    <input onSubmit={this.handlePresenterNameChange} placeholder="Presenter name" required type="text" name="presenter_name" id="presenter_name" className="form-control" />
                    <label htmlFor="presenter_name">Presenter name</label>
                </div>
                <div className="form-floating mb-3">
                    <input onChange={this.handlePresenterEmailChange} placeholder="Presenter email" required type="email" name="presenter_email" id="presenter_email" className="form-control" />
                    <label htmlFor="presenter_email">Presenter email</label>
                </div>
                <div className="form-floating mb-3">
                    <input onChange={this.handleCompanyNameChange} placeholder="Company name" type="text" name="company_name" id="company_name" className="form-control" />
                ...
                <div className="mb-3">
                    ...
                    <textarea onChange={this.handleSynopsisChange} id="synopsis" rows="3" name="synopsis" className="form-control"></textarea>
                </div>
                <div className="mb-3">
